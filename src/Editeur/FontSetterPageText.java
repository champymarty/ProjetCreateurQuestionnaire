...
public class FontSetterPageText extends JFrame {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1591242029000912064L;

	private final String effects[] = {"Plain", "Bold", "Italique", "Bold et Italique"};
	
	private JComboBox<String> cboPolice = new JComboBox<String>(GraphicsEnvironment.getLocalGraphicsEnvironment().getAvailableFontFamilyNames());
	private JComboBox<String> cboEffect = new JComboBox<String>(effects);
